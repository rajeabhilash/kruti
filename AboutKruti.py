...
"}")
        ...
        self.mainLogo.setGeometry(QtCore.QRect(10, 25, 475, 650))
...
"}")
        ...
        self.aboutHead.setGeometry(QtCore.QRect(500, 25, 690, 50))
        font = QtGui.QFont()
        font.setFamily("Caviar Dreams")
...
"}")
        ...
        self.exitAbout.setGeometry(QtCore.QRect(1189, 25, 50, 50))
        font = QtGui.QFont()
        font.setFamily("Caviar Dreams")
        font.setPointSize(15)
        font.setBold(True)
...
"}")
        ...
        self.aboutDetailsWid.setGeometry(QtCore.QRect(500, 75, 739, 600))
...
"text-transform:uppercase;")
        ...
        self.label_5.setGeometry(QtCore.QRect(120, 279, 511, 35))
        font = QtGui.QFont()
        font.setFamily("Caviar Dreams")
...
"border-top-left-radius: 5px;")
    ...
    def retranslateUi(self, aboutWidget):
        ...
        self.label_3.setText(_translate("aboutWidget", "Author, Inventor, UI & UX Designer and Develpoer"))
